...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Sam',		'sam',		'Primary Animator and Writer',	'https://www.youtube.com/user/sjl057',	'7C1308'],
			...
			['Leffrey',		'leffrey',		'Leffrey Week',	'https://twitter.com/markiplier/status/353586063379402753?t=jTho6Vac3ACtMw9OyVh5lQ&s=19',	'282EF4'],
			[''],
			['Psych Engine Team'],
