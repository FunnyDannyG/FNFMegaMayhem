...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Sam',		'sam',		'Danny Animator and Writer',	'https://www.youtube.com/user/sjl057',	'7C1308'],
			['EzoGaming',		'ezogaming',		'Megabyte Animator',	'balls.funnydannyg.net',	'57CEE0'],
			['Pizzi',		'pizzi',		'Composer for Upcoming Weeks',	'https://en.wikipedia.org/wiki/Testicular_torsion',	'2CECBC'],
