...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		if (PlayState.SONG.song.toLowerCase()=='chronokinesis' || PlayState.SONG.song.toLowerCase()=='overclocked' || PlayState.SONG.song.toLowerCase()=='this-ones-final-hours')
		{
			portraitLeft = new FlxSprite(-20, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('textboxes/DannyPortrait', 'shared');
