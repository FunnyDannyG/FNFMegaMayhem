...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		trace('INFORMATION ABOUT WHAT U PLAYIN WIT:\nFRAMES: ' + Conductor.safeFrames + '\nZONE: ' + Conductor.safeZoneOffset + '\nTS: ' + Conductor.timeScale + '\nAutoPlay : ' + FlxG.save.data.botplay);
			...
			case 'MegaMall':
				{
							...
							var bg:FlxSprite = new FlxSprite(-600, -380).loadGraphic(Paths.image('MB_stageback'));
							bg.antialiasing = true;
							bg.scrollFactor.set(0.9, 0.9);
							bg.active = false;
							add(bg);
			...
			case 'Subway':
				{
							...
							phillyTrain = new FlxSprite(2000, -230).loadGraphic(Paths.image('danny_train','shared'));
							if(FlxG.save.data.distractions){
								add(phillyTrain);
							}
			...
			case 'SubwayTOFH':
				{
							...
							var bg:FlxSprite = new FlxSprite(-600, -230).loadGraphic(Paths.image('TOFH_stageback'));
							bg.antialiasing = true;
							bg.scrollFactor.set(0.6, 0.9);
							bg.active = false;
							add(bg);

							var stageFront:FlxSprite = new FlxSprite(-600, -230).loadGraphic(Paths.image('TOFH_stagefront'));
							stageFront.updateHitbox();
							stageFront.antialiasing = true;
							stageFront.scrollFactor.set(0.9, 0.9);
							stageFront.active = false;
		...
		switch (SONG.player2)
		{
			...
			case 'dannyTOFH':
				camPos.x += 600;
				dad.y += 200;
				var AfterImage = new FlxTrail(dad, null, 6, 24, 0.3, 0.069);
				add(AfterImage);
		}
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			switch (SONG.noteStyle)
			{
				...
				case 'nonCanon':
					babyArrow.frames = Paths.getSparrowAtlas('nonCanon');
					babyArrow.animation.addByPrefix('green', 'arrowUP');
					babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
					babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
					babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
	...
	override function beatHit()
	{
		...
		switch (curStage)
		{
			...
			case "Subway":
				...
				if (curBeat % 8 == 4 && FlxG.random.bool(30) && !trainMoving && trainCooldown > 16)
				{
					if(FlxG.save.data.distractions){
