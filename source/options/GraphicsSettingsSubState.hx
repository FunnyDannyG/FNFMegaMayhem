...
class GraphicsSettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Enable New Camera',
			'If checked, enables the new following camera.\nThis makes the camera constantly adjust to follow\ncharacters when singing.',
			'NewCamera',
			'bool',
			true);
		addOption(option);
